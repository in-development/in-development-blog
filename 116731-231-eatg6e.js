...
var _sporto$hop$Hop_Matchers$regex = _Bogdanp$elm_combine$Combine$regex;
...
var _user$project$Routing_Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Routing_Models$NewPostRoute = {ctor: 'NewPostRoute'};
var _user$project$Routing_Models$PostRoute = function (a) {
	return {ctor: 'PostRoute', _0: a};
};
var _user$project$Routing_Models$AdminRoute = {ctor: 'AdminRoute'};
var _user$project$Routing_Models$PostsRoute = {ctor: 'PostsRoute'};

var _user$project$Routing_Matchers$matcherNewPost = A2(_sporto$hop$Hop_Matchers$match1, _user$project$Routing_Models$NewPostRoute, '/post/new');
var _user$project$Routing_Matchers$matcherPost = A3(_sporto$hop$Hop_Matchers$match2, _user$project$Routing_Models$PostRoute, '/post/', _sporto$hop$Hop_Matchers$int);
var _user$project$Routing_Matchers$matcherAdmin = A2(_sporto$hop$Hop_Matchers$match1, _user$project$Routing_Models$AdminRoute, '/admin');
var _user$project$Routing_Matchers$matcherPosts = A2(_sporto$hop$Hop_Matchers$match1, _user$project$Routing_Models$PostsRoute, '');
var _user$project$Routing_Matchers$matchers = _elm_lang$core$Native_List.fromArray(
	[_user$project$Routing_Matchers$matcherPosts, _user$project$Routing_Matchers$matcherAdmin, _user$project$Routing_Matchers$matcherPost, _user$project$Routing_Matchers$matcherNewPost]);

var _user$project$Routing_Config$routerConfig = {basePath: '', hash: true, matchers: _user$project$Routing_Matchers$matchers, notFound: _user$project$Routing_Models$NotFoundRoute};

var _user$project$Routing_Utils$urlParser = _elm_lang$navigation$Navigation$makeParser(
	function (_p0) {
		return A2(
			_sporto$hop$Hop$matchUrl,
			_user$project$Routing_Config$routerConfig,
			function (_) {
				return _.href;
			}(_p0));
	});

var _user$project$Post_Show_Models$initialPost = {id: 0, author: '', text: ''};
var _user$project$Post_Show_Models$Post = F3(
	function (a, b, c) {
		return {id: a, author: b, text: c};
	});


var _user$project$Post_Models$initialPost = _user$project$Post_Show_Models$initialPost;

var _user$project$Models$newAppModel = F2(
	function (route, location) {
		return {
			title: 'Posts',
			posts: _elm_lang$core$Native_List.fromArray(
				[]),
			newPost: _user$project$Post_Models$initialPost,
			location: location,
			route: route
		};
	});
var _user$project$Models$AppModel = F5(
	function (a, b, c, d, e) {
		return {title: a, posts: b, newPost: c, location: d, route: e};
	});

var _user$project$Post_Show_Messages$ShowPost = function (a) {
	return {ctor: 'ShowPost', _0: a};
};

var _user$project$Post_List_Messages$PostMessagesMsg = function (a) {
	return {ctor: 'PostMessagesMsg', _0: a};
};
var _user$project$Post_List_Messages$FetchPostsFail = function (a) {
	return {ctor: 'FetchPostsFail', _0: a};
};
var _user$project$Post_List_Messages$FetchPostsSucceed = function (a) {
	return {ctor: 'FetchPostsSucceed', _0: a};
};
var _user$project$Post_List_Messages$GetPosts = {ctor: 'GetPosts'};

var _user$project$Post_New_Messages$SetText = function (a) {
	return {ctor: 'SetText', _0: a};
};
var _user$project$Post_New_Messages$SetAuthor = function (a) {
	return {ctor: 'SetAuthor', _0: a};
};
var _user$project$Post_New_Messages$AddPostFail = function (a) {
	return {ctor: 'AddPostFail', _0: a};
};
var _user$project$Post_New_Messages$AddPostSucceed = function (a) {
	return {ctor: 'AddPostSucceed', _0: a};
};
var _user$project$Post_New_Messages$SavePost = F2(
	function (a, b) {
		return {ctor: 'SavePost', _0: a, _1: b};
	});

var _user$project$Navigation_Messages$ShowAdmin = {ctor: 'ShowAdmin'};
var _user$project$Navigation_Messages$ShowPosts = {ctor: 'ShowPosts'};

var _user$project$Messages$NavigationMessagesMsg = function (a) {
	return {ctor: 'NavigationMessagesMsg', _0: a};
};
var _user$project$Messages$NewPostMessagesMsg = function (a) {
	return {ctor: 'NewPostMessagesMsg', _0: a};
};
var _user$project$Messages$PostMessagesMsg = function (a) {
	return {ctor: 'PostMessagesMsg', _0: a};
};
var _user$project$Messages$PostsMessagesMsg = function (a) {
	return {ctor: 'PostsMessagesMsg', _0: a};
};
var _user$project$Messages$NoOp = {ctor: 'NoOp'};

var _user$project$Post_Commands$decodePost = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Post_Show_Models$Post,
...
var _user$project$Post_Commands$getPosts = function () {
	var url = 'https://in-development-3.firebaseio.com/blog/posts.json';
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Post_List_Messages$FetchPostsFail,
		_user$project$Post_List_Messages$FetchPostsSucceed,
		A2(
			_evancz$elm_http$Http$get,
			_elm_lang$core$Json_Decode$list(_user$project$Post_Commands$decodePost),
			url));
}();

var _user$project$Post_Show_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var path = A2(
			_elm_lang$core$Basics_ops['++'],
...
var _user$project$Post_List_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'GetPosts':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Post_Commands$getPosts};
			case 'FetchPostsSucceed':
				return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
			case 'FetchPostsFail':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var _p1 = A2(_user$project$Post_Show_Update$update, _p0._0, _user$project$Post_Show_Models$initialPost);
				var msg = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Post_List_Messages$PostMessagesMsg, msg)
				};
		}
	});

var _user$project$Post_New_Commands$decodePost = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Post_Show_Models$Post,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'author', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'text', _elm_lang$core$Json_Decode$string));
var _user$project$Post_New_Commands$postEncoder = function (post) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'author',
				_1: _elm_lang$core$Json_Encode$string(post.author)
			},
				{
				ctor: '_Tuple2',
				_0: 'text',
				_1: _elm_lang$core$Json_Encode$string(post.text)
			}
			]));
};
var _user$project$Post_New_Commands$addPost = F2(
	function (posts, post) {
		var url = 'https://in-development-3.firebaseio.com/blog/posts.json';
		var textBase64 = function () {
			var _p0 = _truqu$elm_base64$Base64$encode(post.text);
			if (_p0.ctor === 'Ok') {
				return _p0._0;
			} else {
				return post.text;
		...
		var postsEncoder = A2(_elm_lang$core$List$map, _user$project$Post_New_Commands$postEncoder, newPosts);
		var body = _evancz$elm_http$Http$string(
			A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_elm_lang$core$Json_Encode$list(postsEncoder)));
		var request = {
			verb: 'PUT',
			headers: _elm_lang$core$Native_List.fromArray(
				[
		...
		return A3(
			_elm_lang$core$Task$perform,
			_user$project$Post_New_Messages$AddPostFail,
			_user$project$Post_New_Messages$AddPostSucceed,
			A2(
				_evancz$elm_http$Http$fromJson,
				_elm_lang$core$Json_Decode$list(_user$project$Post_New_Commands$decodePost),
				A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request)));
	});

var _user$project$Post_New_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SavePost':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Post_New_Commands$addPost, _p0._0, _p0._1)
				};
			case 'AddPostSucceed':
				var lastPost = _elm_lang$core$List$head(
...
var _user$project$Navigation_Update$update = function (msg) {
	var _p0 = msg;
	if (_p0.ctor === 'ShowPosts') {
		return _elm_lang$navigation$Navigation$newUrl('#/');
	} else {
		return _elm_lang$navigation$Navigation$newUrl('#/admin');
	}
};
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'PostsMessagesMsg':
				var _p1 = A2(_user$project$Post_List_Update$update, _p0._0, model.posts);
				var updatedPosts = _p1._0;
				var msg = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{posts: updatedPosts}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$PostsMessagesMsg, msg)
				};
			case 'PostMessagesMsg':
				var _p2 = A2(_user$project$Post_Show_Update$update, _p0._0, _user$project$Post_Models$initialPost);
				var msg = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$PostMessagesMsg, msg)
				};
			case 'NewPostMessagesMsg':
				var _p5 = _p0._0;
				var updatedPosts = function () {
					var _p3 = _p5;
					if (_p3.ctor === 'AddPostSucceed') {
						return _p3._0;
					} else {
						return model.posts;
					}
				}();
				var _p4 = A2(_user$project$Post_New_Update$update, _p5, model.newPost);
				var updatedNewPost = _p4._0;
				var msg = _p4._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newPost: updatedNewPost, posts: updatedPosts}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$NewPostMessagesMsg, msg)
				};
			default:
				var msg = _user$project$Navigation_Update$update(_p0._0);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$NavigationMessagesMsg, msg)
				};
		}
	});

var _user$project$Post_Show_View$postText = function (text) {
	return A2(
		_evancz$elm_markdown$Markdown$toHtml,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('content hlsj')
			]),
		text);
};
var _user$project$Post_Show_View$postView = function (post) {
	var postTextStr = function () {
		var _p0 = _truqu$elm_base64$Base64$decode(post.text);
		if (_p0.ctor === 'Ok') {
			return _p0._0;
		} else {
			return '';
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id(postId),
				_elm_lang$html$Html_Attributes$href('javascript://'),
				_elm_lang$html$Html_Events$onClick(
				_user$project$Post_Show_Messages$ShowPost(post)),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'border', _1: 'solid 1px #000000'},
								{ctor: '_Tuple2', _0: 'width', _1: '70%'},
								{ctor: '_Tuple2', _0: 'left', _1: '10%'},
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'margin', _1: '0.5em 0 0 0.5em'}
									]))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$Post_Show_View$postText(postTextStr)
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										{ctor: '_Tuple2', _0: 'margin', _1: '0.5em 0.5em 0.5em 0'},
...
var _user$project$Post_List_View$postsView = function (posts) {
	var postList = A2(_elm_lang$core$List$map, _user$project$Post_Show_View$postView, posts);
	var postVW = function () {
		var _p0 = posts;
		if (_p0.ctor === '[]') {
			return A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$html$Html_App$map, _user$project$Post_List_Messages$PostMessagesMsg, postVW)
			]));
};

var _user$project$Post_New_View$newPostView = F2(
						...
						[
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											{ctor: '_Tuple2', _0: 'clear', _1: 'right'}
										]))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$html$Html_Events$onInput(_user$project$Post_New_Messages$SetAuthor)
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						])),
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											{ctor: '_Tuple2', _0: 'min-height', _1: '400px'}
										])),
									_elm_lang$html$Html_Attributes$value(model.text),
									_elm_lang$html$Html_Events$onInput(_user$project$Post_New_Messages$SetText)
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						])),
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											{ctor: '_Tuple2', _0: 'min-height', _1: '30px'},
											{ctor: '_Tuple2', _0: 'font-size', _1: '1em'},
											{ctor: '_Tuple2', _0: 'cursor', _1: 'pointer'}
										])),
									_elm_lang$html$Html_Events$onClick(
									A2(_user$project$Post_New_Messages$SavePost, posts, model))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
...
var _user$project$Navigation_View$menuLink = F3(
	function (message, viewId, label) {
		return A2(
			_elm_lang$html$Html$a,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$id(viewId),
					_elm_lang$html$Html_Attributes$href('javascript://'),
...
var _user$project$Navigation_View$menuView = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'background-color', _1: '#000000'},
					{ctor: '_Tuple2', _0: 'color', _1: '#FFFFFF'}
				]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A3(_user$project$Navigation_View$menuLink, _user$project$Navigation_Messages$ShowPosts, 'btnPosts', 'Posts'),
					_elm_lang$html$Html$text(' | '),
					A3(_user$project$Navigation_View$menuLink, _user$project$Navigation_Messages$ShowAdmin, 'btnAdmin', 'Admin')
				]))
		]));
...
var _user$project$View$pageView = function (model) {
	var _p0 = model.route;
	switch (_p0.ctor) {
		case 'PostsRoute':
			return A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$html$Html_App$map,
								_user$project$Messages$PostsMessagesMsg,
								_user$project$Post_List_View$postsView(model.posts))
							]))
					]));
		case 'AdminRoute':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Admin')
							]))
					]));
		case 'PostRoute':
			var post = _elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (p) {
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									_elm_lang$html$Html_App$map,
									_user$project$Messages$PostMessagesMsg,
									_user$project$Post_Show_View$postView(_p1._0))
								]))
						]));
			} else {
		...
		case 'NewPostRoute':
			...
			var newId = _elm_lang$core$List$length(model.posts);
			var post = _elm_lang$core$Native_Utils.update(
				newPost,
				{id: newId});
			return A2(
				_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$html$Html_App$map,
								_user$project$Messages$NewPostMessagesMsg,
								A2(_user$project$Post_New_View$newPostView, model.posts, post))
							]))
					]));
		default:
			return _user$project$View$notFoundView;
...
var _user$project$View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$html$Html_App$map, _user$project$Messages$NavigationMessagesMsg, _user$project$Navigation_View$menuView),
				_user$project$View$pageView(model)
			]));
};
...
var _user$project$Main$init = function (_p0) {
	...
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Models$newAppModel, _p1._0, _p1._1),
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$PostsMessagesMsg, _user$project$Post_Commands$getPosts)
	};
};
	...
	function (_p2, model) {
		...
		var isPosts = function () {
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				function (p) {
					return _elm_lang$core$Native_Utils.eq(p, 'posts');
				},
				path);
		}();
		var r = function () {
			var _p4 = isPosts;
			if (_p4 === true) {
				return _user$project$Routing_Models$PostsRoute;
			} else {
				return _p3._0;
			}
		}();
...
var _user$project$Main$main = {
	main: A2(
		...
		_user$project$Routing_Utils$urlParser,
		{init: _user$project$Main$init, view: _user$project$View$view, update: _user$project$Update$update, urlUpdate: _user$project$Main$urlUpdate, subscriptions: _user$project$Subscriptions$subscriptions})
};
